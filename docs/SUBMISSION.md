...
| 0:25–0:55 | Maya's **Sources** and **Tools** pages: repo, Confluence space, GitHub tools with 28 read / 19 write, write switch | "Maya, the owner, gives it what she'd give a new hire: the wiki, the repo, and an account on GitHub — connected as an MCP server. Every tool is classified read or write. Writes are off until she says otherwise." |
